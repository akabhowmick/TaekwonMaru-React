...
const adultClass: ClassInfo = {
  title: "Adult (18+)",
  subtitle: "Click to learn more about the Adult class!",
  details: [
...
const littleTigerClass: ClassInfo = {
  ...
  subtitle: "Click to learn more about the Little Tiger class!",
  details: [
...
const preTeenClass: ClassInfo = {
  ...
  subtitle: "Click to learn more about Pre-Teen classes!",
  details: [
...
const childrenClass: ClassInfo = {
  title: "Children (6-9)",
  subtitle: "Click to learn more about the Children's class!",
  details: [
...
const kpopDanceClass: ClassInfo = {
  ...
  subtitle: "Click to learn more about the Kpop Dance class!",
  details: [
...
const sparringClass: ClassInfo = {
  ...
  subtitle: "Click to learn more about the sparring class!",
  details: [
...
const juniorLeader: ClassInfo = {
  title: "Junior Leader",
  subtitle: "Click to learn more about the junior leader program!",
  details: [
...
const blackHawkDemoTeam: ClassInfo = {
  title: "Demo Team",
  subtitle: "Click to learn more about our Demo Team!",
  details: [
